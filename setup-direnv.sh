...
cat > ~/WORKSPACE/raolivei/new-project.sh << 'EOF'
#!/bin/bash
...
chmod +x ~/WORKSPACE/raolivei/new-project.sh
...
echo "   ${YELLOW}./new-project.sh my-test-project${NC}"
echo ""
...
echo "   • ~/WORKSPACE/raolivei/new-project.sh (helper script)"
